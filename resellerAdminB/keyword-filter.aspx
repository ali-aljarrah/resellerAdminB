<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="keyword-filter.aspx.cs" Inherits="resellerAdminB.keyword_filter" %>
...
<title>Reseller Admin - Keyword Filter</title>
</head>
<!--end::Head-->
<!--begin::Body-->
    ...
    <form class="d-flex flex-fill" action="#" method="post" runat="server">
        ...
        <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
            ...
            <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
                <!--begin::Header-->
                <uc1:MenuTop runat="server" ID="MenuTop" parentPageText="Spam Firewall" childPageText="Keyword Filter" />
                <!--end::Header-->
                <!--begin::Wrapper-->
                                        ...
                                        <div class="col-md-12 mb-md-0 mb-5 mt-5">
                                            <div class="card card-flush shadow-xs border-0 p-8">
                                                ...
                                                <div class="d-flex justify-content-between align-items-start flex-column flex-md-row">
                                                        ...
                                                        <div class="page-title gap-1 d-flex justify-content-between align-items-start mb-5 mb-md-0">
                                                            <div>
                                                                ...
                                                                <div class="d-flex justify-content-start align-items-center mb-1">
                                                                    <h1 class="page-heading pt-3 text-dark fw-bold m-0 me-3">Keyword Filter</h1>
                                                                </div>
                                                                <p class="fs-14 color-neutral-grey">
                                                                    View and manage all blocked keywords and add new.
                                                                </p>
                                                                <!--end::Title-->
                                                            </div>
                                                        </div>
                                                        <!--end::Page title-->
                                                        <!--begin::Header-->
                                                        <button type="button" class="btn btn-grad-1" id="btn-modal-popup" data-bs-toggle="modal" data-bs-target="#popupBlockedKeyword">
                                                            Add New Keyword
                                                        </button>
                                                        <!--end::Header-->
                                                    </div>
                                                ...
                                                <div class="card-body pb-4 mt-0 pt-5 ps-0 pr-0">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="blocked-keyword-report" class="table custom-table table-bordered table-striped gy-5">

                                                            <thead>
                                                                <tr class="fs-12 fw-600">
                                                                    <th class="white-color">Spam Word</th>
                                                                ...
                                                                <tr class="fs-12">
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex justify-content-center align-items-center">
                                                                             <a class="me-5 action-btn" href="/edit-keyword-filter.aspx" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit keyword Filter">
                                                                             ...
                                                                             <a class="action-btn" href="#" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete keyword Filter" onclick="confirmDelete('128');">
                                                                                 <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        <div class="modal fade" tabindex="-1" id="popupBlockedKeyword">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title">Add New keyword Filter</h3>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-5">
                                    <label for="spamWord" class="form-label required">Spam keyword</label>
                                    <input class="form-control form-custom-input" value="" type="text" name="spamWord" id="spamWord" runat="server" placeholder="Enter new spam word to filter">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-8">
                                    <label for="spamStatus" class="form-label required">Status</label>
                                    <select runat="server" name="spamStatus" id="spamStatus" class="form-select form-custom-select">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div>
                                    <input class="form-control form-custom-input" value="" type="text" name="filterSpamWordUsername" id="filterSpamWordUsername" runat="server" placeholder="Enter username here..." disabled="disabled">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer">
                        <asp:Button ID="AddNewSpamFilterBtn" runat="server" Text="Add spam filter"
                            CssClass="btn btn-grad-1 py-2 px-6 rounded-1"
                            OnClientClick="addSpamFilterSubmit('AddNewSpamFilterBtn'); return false;" OnClick="AddNewSpamFilterBtn_Click"/>
                    </div>
                </div>
            </div>
        </div>
        <uc1:footerLinks runat="server" ID="footerLinks" />
        <script src="assets/js/keyword-filter.js"></script>
