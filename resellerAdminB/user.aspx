                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                                                ...
                                                                <div class="d-flex flex-column">
                                                                    ...
                                                                    <div class="d-flex align-items-center mb-2">
                                                                        ...
                                                                        <div class="mx-4 d-flex justify-content-between align-items-center">
                                                                            <div>
                                                                                <select class="form-select form-custom-select py-1" name="userStatus" id="userStatus">
                                                                ...
                                                                <div class="d-flex justify-content-between align-items-center my-4">
                                                                    ...
                                                                    <button type="button" class="btn btn-grad-1 py-2 px-6 ms-5" id="btn-modal-popup-add-credit" data-bs-toggle="modal" data-bs-target="#AddCreditsModal">
