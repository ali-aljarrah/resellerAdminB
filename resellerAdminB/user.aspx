                                                                            ...
                                                                            <div class="mb-6">
                                                                                ...
                                                                                <div class="mt-5">
                                                                                    <form action="#">
                                                                                        <div class="row my-4">
                                                                                            ...
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-5">
                                                                                                    ...
                                                                                                    <input class="form-control form-custom-input" value="" type="date" name="userBirthday" id="userBirthday" placeholder="Enter user birthday date">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-5">
                                                                                        ...
                                                                                        <button type="button" class="btn btn-grad py-2 px-8 rounded-3" id="editAccountInfoSubmitBtn">
                                                                            ...
                                                                            <div class="mb-6">
                                                                                ...
                                                                                <div class="mt-5">
                                                                                    <form action="#">
                                                                                        ...
                                                                                        <button type="button" class="btn btn-grad py-2 px-8 rounded-3" id="editContactDetailsSubmitBtn">
                                                                                            <span class="indicator-label">Save changes</span>
                                                                                            <span class="indicator-progress">
                                                                                                <span class="spinner-border text-white" role="status">
                                                                                                    <span class="visually-hidden">Loading...</span>
                                                                                        ...
                                                                                        <div class="row my-4">
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-5">
                                                                                                    ...
                                                                                                    <input required class="form-control form-custom-input" value="" type="password" name="oldPassword" id="oldPassword" placeholder="Enter your account current password">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-5">
                                                                                                    <label for="newPassword" class="form-label required">New password</label>
                                                                                                    <input required class="form-control form-custom-input" value="" type="password" name="newPassword" id="newPassword" placeholder="Enter the new password">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-md-6">
                                                                                                <div class="mb-5">
                                                                                                    <label for="confirmNewPassword" class="form-label required">Confirm new password</label>
                                                                                                    <input required class="form-control form-custom-input" value="" type="password" name="confirmNewPassword" id="confirmNewPassword" placeholder="Confirm account new password">
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        <button type="button" class="btn btn-grad py-2 px-8 rounded-3" id="changePasswordSubmitBtn">
                        ...
                        <div class="row my-4 p-8">
                            <div class="col-lg-6">
                                <div class="mb-5">
                                    ...
                                    <input class="form-control form-custom-input mt-3 p-2" value="" type="text" name="newUserFullName" id="newUserFullName" runat="server" placeholder="Enter new user full name">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-5">
                                    <label for="newUserEmail" class="form-label required">Email</label>
                                    <input class="form-control form-custom-input mt-3 p-2" value="" type="email" name="newUserEmail" id="newUserEmail" runat="server" placeholder="Enter new user email">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-5">
                                    <label for="newUserPhoneNumber" class="form-label required">Phone number</label>
                                    <input class="form-control form-custom-input mt-3 p-2" value="" type="text" onkeypress="return goodchars(event,'0123456789,+');" name="newUserPhoneNumber" id="newUserPhoneNumber" runat="server" placeholder="Enter new user phone number">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-5">
                                    <label for="newUserAddress" class="form-label">Address</label>
                                    <input class="form-control form-custom-input mt-3 p-2" value="" type="text" name="newUserAddress" id="newUserAddress" runat="server" placeholder="Enter new user address">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-5">
                                    <label for="newUserCity" class="form-label">City</label>
                                    <input class="form-control form-custom-input mt-3 p-2" value="" type="text" name="newUserCity" id="newUserCity" runat="server" placeholder="Enter new user city">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-5">
                                    <label for="newUserState" class="form-label">State</label>
                                    <input class="form-control form-custom-input mt-3 p-2" value="" type="text" name="newUserState" id="newUserState" runat="server" placeholder="Enter new user state">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-5">
