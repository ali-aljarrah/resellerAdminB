<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit-keyword-filter.aspx.cs" Inherits="resellerAdminB.edit_keyword_filter" %>
...
<title>Reseller Admin - Edit Spam Keyword Filter</title>
</head>
<!--end::Head-->
<!--begin::Body-->
    ...
    <form class="d-flex flex-fill" action="#" name="editSenderfilterform" id="editSenderfilterform" runat="server">
        ...
        <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
            ...
            <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
                <!--begin::Header-->
                <uc1:MenuTop runat="server" ID="MenuTop" parentPageText="Spam Keyword Filter" childPageText="Edit Spam Keyword Filter" />
                <!--end::Header-->
                <!--begin::Wrapper-->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-md-0 mb-5">
                                            <div class="card shadow-xs p-8 d-flex my-5">
                                                <div class="mb-6">
                                                    <a href="/keyword-filter.aspx" class="d-flex align-items-center w-fit">
                                                        <span class="me-3">
                                                        ...
                                                        <span class="fs-14 text-dark">Back to Spam Keyword Filter list</span>
                                                    </a>
                                                </div>
                                                <!--begin::Page title-->
                                                <div class="page-title gap-1 d-flex justify-content-between align-items-start">
                                                    <div>
                                                        <!--begin::Title-->
                                                        <h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bold my-5">Edit Spam keyword Filter</h1>
                                                        <!--end::Title-->
                                                    </div>
                                                </div>
                                                <!--end::Page title-->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="mb-5">
                                                                ...
                                                                <input class="form-control form-custom-input" value="apple" type="text" name="spamWord" id="spamWord" runat="server" placeholder="Enter new sender name to filter">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="mb-8">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <asp:Button ID="EditSpamFilterBtn" runat="server" Text="Edit sender filter"
                                                                CssClass="btn btn-grad-1 py-2 px-6 rounded-1 ms-auto"
                                                                OnClientClick="editSpamFilterSubmit('EditSpamFilterBtn'); return false;" OnClick="EditSpamFilterBtn_Click"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <script src="assets/js/edit-keyword-filter.js"></script>
